...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    train_loader, dataset = create_dataloader(
        ...
        saveMosaicImg=opt.save_mosaic_imgs,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--save_mosaic_imgs', action='store_true', help='Saving the mosaic images')
    parser.add_argument('--concat_set', action='store_true', help='Being the concat set')
